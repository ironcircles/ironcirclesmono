...
Color?strengthColorMap(String value) {

  double _strength= estimatePasswordStrength(value);

  if (_strength < .2)
    return globalState.theme.weakPassword;
  else if (_strength < .4)
    return globalState.theme.weakPassword;
  else if (_strength < .6)
    return globalState.theme.mediumPassword;
  else if (_strength < .8)
    return globalState.theme.strongPassword;
  else if (_strength < 1)
    return globalState.theme.strongPassword;
  else if (_strength == 1) return globalState.theme.superStrongPassword;
...
String getStrengthString(String value) {
  String retValue = "";
  double strength;
  ...
  if (value.isNotEmpty) {
    ...
    if (strength < .2)
      retValue = "password strength is weak";
    else if (strength < .4)
      retValue = "password strength is weak";
    else if (strength < .6)
      retValue = "password strength is average";
    else if (strength < .8)
      retValue = "password strength is good";
    else if (strength < 1)
      retValue = "password strength is good";
    else if (strength == 1) retValue = "password strength is great";
...
double estimatePasswordStrength(String password) {
  return _estimateBruteforceStrength(password) *
      _estimateCommonDictionaryStrength(password);
}
...
double _estimateCommonDictionaryStrength(String password) {
