...
class CircleNew extends StatefulWidget {
...
class NewCircleState extends State<CircleNew> {
        ...
        for (UserFurnace userFurnace in _userFurnaces!) {
          if (userFurnace.connected!) {
            _furnaceList.add(DropDownPair(
                ...
                value: '${StringHelper.truncate(userFurnace.alias!, 30)} (${StringHelper.truncate(userFurnace.username!, 18)})'));
          }
        }
