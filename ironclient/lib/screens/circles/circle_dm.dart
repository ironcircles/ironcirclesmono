...
class CircleDMWidget extends StatefulWidget {
  ...
  @override
  _CircleDMWidgetState createState() => _CircleDMWidgetState();
}

class _CircleDMWidgetState extends State<CircleDMWidget> {
  @override
  void dispose() {
    super.dispose();
  }
