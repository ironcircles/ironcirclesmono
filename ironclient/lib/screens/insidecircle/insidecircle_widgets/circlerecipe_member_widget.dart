...
class CircleRecipeMemberWidget extends StatefulWidget {
  ...
  const CircleRecipeMemberWidget(
      this.circleObject,
      this.userFurnace,
      this.showAvatar,
      this.showDate,
  ...
  @override
  CircleRecipeMemberWidgetState createState() =>
      CircleRecipeMemberWidgetState();
}

class CircleRecipeMemberWidgetState extends State<CircleRecipeMemberWidget> {
  //int _radioValue = -1;
