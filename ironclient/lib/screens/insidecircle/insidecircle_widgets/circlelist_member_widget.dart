...
class CircleListMemberWidget extends StatefulWidget {
  ...
  @override
  CircleListMemberWidgetState createState() => CircleListMemberWidgetState();
}

class CircleListMemberWidgetState extends State<CircleListMemberWidget> {
                                                                ...
                                                                Text(
                                                                  ...
                                                                  textScaler: TextScaler.linear(
                                                                      globalState
                                                                          .messageHeaderScaleFactor),
                                                                  style: TextStyle(
                                                                      color: widget.circleObject.list!.lastEdited!.id ==
                                                                              widget
                                                                                  .userFurnace.userid
                                                                          ? globalState
                                                                              .theme
                                                                          ...
                                                                          : Member.getMemberColor(
                                                                              widget.userFurnace,
                                                                              widget.circleObject.list!.lastEdited!)),
                                                                )
                                                              ])
                                                        : Container(),
                                                    widget.circleObject.list!
                                                                ...
                                                                return index > 4
                                                                    ? index ==
                                                                        ...
                                                                        ? Center(
                                                                            ...
                                                                            style:
                                                                                TextStyle(color: globalState.theme.listExpand),
                                                                          ))
                                                                        : Container()
                                                                    : Container(
