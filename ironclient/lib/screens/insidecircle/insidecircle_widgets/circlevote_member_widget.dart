...
class CircleVoteMemberWidget extends StatefulWidget {
  ...
  @override
  CircleVoteMemberWidgetState createState() => CircleVoteMemberWidgetState();
}

class CircleVoteMemberWidgetState extends State<CircleVoteMemberWidget> {
  //int _radioValue = -1;
                                                                  ...
                                                                  children: <Widget>[
                                                                    SizedBox(
                                                                        ...
                                                                        child:
                                                                            Radio(
                                                                          fillColor:
                                                                              MaterialStateProperty.resolveWith(globalState.getRadioColor),
