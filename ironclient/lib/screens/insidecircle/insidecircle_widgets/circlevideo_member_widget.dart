...
class CircleVideoMemberWidget extends StatefulWidget {
  ...
  @override
  _CircleVideoMemberWidgetState createState() =>
      _CircleVideoMemberWidgetState();
}

class _CircleVideoMemberWidgetState extends State<CircleVideoMemberWidget> {
                                                                ...
                                                                child: widget
                                                                    ...
                                                                    ? widget.circleObject.video ==
                                                                        ...
                                                                        : widget.circleObject.video!.videoState == VideoStateIC.DOWNLOADING_VIDEO
                                                                            ...
                                                                            : (widget.circleObject.video!.videoState == VideoStateIC.PREVIEW_DOWNLOADED || widget.circleObject.retries >= 5) && VideoCacheService.isPreviewCached(widget.circleObject, widget.userCircleCache.circlePath!) //s, path)idget.circleObject.video!.videoState == VideoStateIC.PREVIEW_DOWNLOADED /*|| widget.circleObject.video!.previewFile != null*/
                                                                                ? Stack(
                                                                                    alignment: Alignment.center,
                                                                                    children: [
                                                                                      globalState.isDesktop() && widget.circleObject.video!.streamable == false
                                                                                ...
                                                                                : widget.circleObject.video!.videoState == VideoStateIC.NEEDS_CHEWIE
                                                                                    ? InkWell(
                                                                                        ...
                                                                                        child: Stack(
                                                                                          alignment: Alignment.center,
                                                                                          children: [
                                                                                            globalState.isDesktop() && widget.circleObject.video!.streamable == false ? sizedMemCacheImage : sizedImage,
                                                                                            widget.play != null
                                                                                                ? globalState.isDesktop() && _imageDecrypted == false && widget.circleObject.video!.streamable == false
                                                                                                    ? Container()
                                                                                                    : Padding(
