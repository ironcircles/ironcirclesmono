...
import 'package:ironcirclesapp/screens/insidecircle/insidecircle_widgets/showreply_widget.dart';
import 'package:ironcirclesapp/utils/emojiutil.dart';

class CircleObjectBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (circleObject.reply != null)
      alias =
          Member.returnAlias(circleObject.replyUserID!, globalState.members);

    final bodyWidget = circleObject.body == null || circleObject.body!.isEmpty
        ? Container()
        : circleObject.emojiOnly == null || circleObject.emojiOnly == false
            ? EmojiUtil.containsEmoji(circleObject.body!) ||
                    (circleObject.taggedUsers != null &&
                        circleObject.taggedUsers!.isNotEmpty)
                ? TextBold(
    ...
    return circleObject.reply != null || circleObject.replyObjectID != null
        ? InkWell(
            onTap: () {
                  ...
                  : Column(crossAxisAlignment: crossAxisAlignment, children: [
                      Row(
                          ...
                          children: [
                            Flexible(
                                child: Text(
                                  replyObject == null ? "reply to ${circleObject.replyUsername!}${alias.isEmpty ? '' : ' ($alias)'}: ${circleObject.reply!}" : "reply to ${circleObject.replyUsername!}${alias.isEmpty ? '' : ' ($alias)'}: ${replyObject!.type == CircleObjectType.CIRCLELINK ? '[link]' : circleObject.reply!}",
                              softWrap: true,
        ...
        : circleObject.verificationFailed.isNotEmpty &&
...
class CircleObjectBodyWrapped extends StatelessWidget {
  final CircleObject circleObject;
  final CircleObject? replyObject;
  final Function? replyObjectTapHandler;
  final UserCircleCache userCircleCache;
