...
class WallFileWidget extends StatefulWidget {
  ...
  @override
  _WallFileWidgetState createState() => _WallFileWidgetState();
}

class _WallFileWidgetState extends State<WallFileWidget> {
