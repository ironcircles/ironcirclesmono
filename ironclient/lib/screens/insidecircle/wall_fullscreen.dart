...
//
// class WallFullScreenWidget extends StatefulWidget {
...
//
//   @override
//   State<WallFullScreenWidget> createState() => _WallWidgetState();
// }
//
// class _WallWidgetState extends State<WallFullScreenWidget> {
...
//                           context,
//                           MaterialPageRoute(
//                             builder: (context) => const StableDiffusionWidget(),
//                           ),
//                         );
//
//                         if (file != null) {
...
//                               .populateFromFiles([file], MediaType.image);
//
//                           _previewMedia(mediaCollection);
//                         }
//                       },
//                       child:
//                           ICText('AI', fontSize: 10, color: Colors.grey[800]))),
//             ),
//           ),
//         ));
//
//     /*final markup = InkWell(
//         onTap: () {},
//         child: Padding(
//         padding: const EdgeInsets.only(right: 10, bottom: 10),
//         child: Container(
...
//                           child: _selectedTab == SelectedLibraryTab.gallery
//                               ? Row(
//                                   crossAxisAlignment: CrossAxisAlignment.end,
...
//                                   mainAxisAlignment: MainAxisAlignment.end,
//                                   children: [
//                                       _selectedTab == SelectedLibraryTab.files
//                                           ? file
//                                           : _selectedTab ==
//                                                   SelectedLibraryTab.recipes
//                                               ? recipe
//                                               : _selectedTab ==
//                                                       SelectedLibraryTab.links
//                                                   ? link
//                                                   : _selectedTab ==
//                                                           SelectedLibraryTab
//                                                               .events
