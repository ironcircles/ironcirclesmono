...
class RecipeIngredient extends StatefulWidget {
  final CircleRecipeIngredient? circleRecipeIngredient;
  ...
  @override
  RecipeIngredientState createState() => RecipeIngredientState();
}

class RecipeIngredientState extends State<RecipeIngredient> {
  ...
  Widget build(BuildContext context) {
    return Padding(
        padding:
            const EdgeInsets.only(top: 4, bottom: 0, left: 5, right: 7),
        child:
              ...
              children: <Widget>[
                ...
                Padding(
                    ...
                    child: CircleAvatar(
                        radius: 18,
                        backgroundColor:
                            globalState.theme.recipeIconBackground,
                        child: Text(
                          widget.circleRecipeIngredient!.order.toString(),
                          style: TextStyle(
                              fontSize: 13,
                              color:
                                  globalState.theme.recipeIconForeground),
                        ))),
                //child: Text('1')),
                ...
                Expanded(
                  ...
                  child: ExpandingLineText(
                    ...
                    onChanged: (text) {
                      widget.circleRecipeIngredient!.name = text;
                    },
                    controller: widget.circleRecipeIngredient!.controller,
                ...
                widget.screenMode == ScreenMode.READONLY
                    ...
                    : ClipOval(
                        child: Material(
                          color: globalState
                              .theme.tabBackground, // button color
                          child: InkWell(
                            splashColor: globalState.theme
                                .buttonLineBackground, // inkwell color
                            child: SizedBox(
                                width: _iconSize,
                                height: _iconSize,
                                child: Icon(
