...
import 'package:ironcirclesapp/screens/widgets/reactions/reactions_box.dart';
...
class FlutterReactionButtonCheck extends StatefulWidget {
  ...
  const FlutterReactionButtonCheck({
    Key? key,
    ...
    this.highlightColor,
    this.splashColor,
    this.boxPosition = Position.BOTTOM,
  ...
  void _showReactionButtons(BuildContext context) async {
    ...
    final reactionButton = await Navigator.of(context).push(
      PageRouteBuilder(
        ...
        pageBuilder: (_, __, ___) => ReactionsBox(keyboardSize: keyboard, globalKey: _buttonKey,
