...
class VideoMediaKitWidget extends StatefulWidget {
  final mediaType.Media video;
  final Function? play;
  final VideoController? videoController;
  final VideoControllerMediaDesktopBloc videoControllerBloc;
  final Function dispose;
  final double width;
  final double height;

  const VideoMediaKitWidget(
      {required this.video,
      this.play,
...
class _VideoWidgetState extends State<VideoMediaKitWidget> {
