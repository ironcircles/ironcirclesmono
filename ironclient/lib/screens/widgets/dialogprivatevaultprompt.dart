...
enum DialogPrivateVaultPromptResponse {
  doNothing,
  hide,
  guard,
}

class DialogPrivateVaultPrompt {
        ...
        child: AlertDialog(
          ...
          title: Column(
            children: [
              ...
              ICText(
                AppLocalizations.of(context)!.welcomeToVault,
                textScaleFactor: 1,
    ...
    return SizedBox(
        ...
        /*height: globalState.userSetting.allowHidden == false ||
            ...
            : globalState.mediaScaleFactor > 1.5
                ? 277
                : 214, //widget.firstTime ? 340  : 340, //widget.firstTime ? 340  : 340,
          ...
          body: Column(
              ...
              children: <Widget>[
                Padding(
                    ...
                    child: ICText(
                      AppLocalizations.of(context)!.welcomeToVaultDescription,
                    )),
                const Padding(
