...
class ICPainter extends StatefulWidget {
  final PainterController painterController;

  ICPainter(PainterController painterController)
      : this.painterController = painterController,
        super(key: ValueKey<PainterController>(painterController));

  @override
  _ICPainterState createState() => _ICPainterState();
}

class _ICPainterState extends State<ICPainter> {
          ...
          children: <Widget>[
            ConstrainedBox(
                constraints: BoxConstraints.expand(
                  ...
                  //maxHeight: MediaQuery.of(context).size.height - 370,
                  // maxHeight: MediaQuery.of(context).size.height - (_showScrolller ? _heightWithScroller : _heightWithoutScroller),
                  //minWidth:
                  //maxWidth: 250,
                ),
                child: widget.painterController.backgroundImage!),
            GestureDetector(
              child: child,
              onPanStart: _onPanStart,
              onPanUpdate: _onPanUpdate,
