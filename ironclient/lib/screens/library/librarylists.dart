...
class LibraryLists extends StatefulWidget {
...
class _LocalState extends State<LibraryLists> {
  ...
  Widget build(BuildContext context) {
    ...
    ListTile makeListTile(int index, CircleObject object) => ListTile(
          ...
          leading: Container(
            ...
            child:
                Icon(Icons.check_box, color: globalState.theme.cardLeadingIcon),
          ),
          title: Container(
                ...
                Expanded(
                    ...
                    child: Padding(
                        padding: const EdgeInsets.only(
                            left: 5.0, bottom: 5, top: 10),
                        child: Text(
                          object.list!.complete ? 'Complete' : 'Incomplete',
                          textScaler: TextScaler.linear(globalState.cardScaleFactor),
